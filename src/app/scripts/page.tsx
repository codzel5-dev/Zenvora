...
import { Terminal, ArrowRight, Copy, Check, Download, FileCode, Zap } from 'lucide-react';
            ...
            <button
              ...
              className={`px-4 py-2 text-sm rounded-full border transition-colors ${
                cat.active
                  ...
                  : 'bg-background border-border hover:border-sky-300 dark:hover:border-sky-700 text-muted-foreground hover:text-foreground'
              }`}
            >
              {cat.name}
            </button>
